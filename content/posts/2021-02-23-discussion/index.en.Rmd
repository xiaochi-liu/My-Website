...
tags: 
  - Scientific Writing
subtitle: ''
description: 'How to write the Discussion Section of journal paper'
...
* **answer the question(s) posed in the Introduction**
...
Need to pay attention to verb choice: (1) attitude to findings; (2)strength of claim.
...
It's important to match strength of sentences with the strength of the data / arguments


In the **main clause**, which verb is making the stronger claim?
...
In the **that clause**, the tense of Verb could be:
